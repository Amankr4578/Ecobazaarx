...
const OrderTracking: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-[#FBFBFB] min-h-screen">
      <div className="mb-10">
        <Link to="/history" className="flex items-center gap-2 text-slate-400 text-xs font-black uppercase tracking-widest hover:text-emerald-600 transition-colors mb-6">
