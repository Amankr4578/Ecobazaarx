...
export function initDb() {
  ...
  const productImages: Record<string, string> = {
    ...
    'Plastic Toothbrush': 'https://images.unsplash.com/photo-1600180758890-6b94519a8ba6?auto=format&fit=crop&q=80&w=800',
    'Disposable Water Bottle': 'https://images.unsplash.com/photo-1523362628745-0c100150b504?auto=format&fit=crop&q=80&w=800',
    'Natural Deodorant': 'https://images.unsplash.com/photo-1599433027429-b9573b2ad942?auto=format&fit=crop&q=80&w=800',
    ...
    'Glass Water Bottle': 'https://images.unsplash.com/photo-1602143399827-7211aa9ad945?auto=format&fit=crop&q=80&w=800',
    ...
    'Biodegradable Phone Case': 'https://images.unsplash.com/photo-1586105251261-72a75665ff2f?auto=format&fit=crop&q=80&w=800',
    'Recycled Sunglasses': 'https://images.unsplash.com/photo-1511499767390-903390e62bc0?auto=format&fit=crop&q=80&w=800',
    ...
    'Stainless Steel Water Bottle': 'https://images.unsplash.com/photo-1602143399827-7211aa9ad945?auto=format&fit=crop&q=80&w=800',
  ...
  if (productCount.count < 20) {
    ...
    const initialProducts = [
      ...
      [
        'Plastic Toothbrush', 'StandardCare', 'Personal Care', 1.99, 'https://images.unsplash.com/photo-1600180758890-6b94519a8ba6?auto=format&fit=crop&q=80&w=800', 15, 2.5, 'Low', 'Standard plastic toothbrush. High environmental impact.',
      ...
      [
        'Disposable Water Bottle', 'AquaPure', 'Kitchen', 1.00, 'https://images.unsplash.com/photo-1523362628745-0c100150b504?auto=format&fit=crop&q=80&w=800', 10, 3.0, 'Low', 'Single-use plastic water bottle. Significant plastic waste.',
      ...
      [
        'Natural Deodorant', 'PureScent', 'Personal Care', 9.50, 'https://images.unsplash.com/photo-1599433027429-b9573b2ad942?auto=format&fit=crop&q=80&w=800', 91, 0.12, 'High', 'Plastic-free aluminum-free deodorant.',
      ...
      [
        'Glass Water Bottle', 'ClearAqua', 'Kitchen', 18.00, 'https://images.unsplash.com/photo-1602143399827-7211aa9ad945?auto=format&fit=crop&q=80&w=800', 92, 0.1, 'High', 'Reusable borosilicate glass bottle.',
    ...
    const allProducts = db.prepare('SELECT id, name FROM products').all() as { id: number, name: string }[];
